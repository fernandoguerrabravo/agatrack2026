...
4. Incluye información del shipper, consignee, notify party con direcciones completas. IMPORTANTE BL MASTER vs HOUSE: Si el BL tiene dos números (uno marcado como MBL/Master y otro como HBL/House o con "(h)"), identificar ambos: numero_bl_master (MBL - el principal para tracking) y numero_bl_house (HBL - el hijo). En BLs de freight forwarders como Danmar Lines, el número principal para tracking en navieras es el MBL. Reportar siempre numero_bl como el MBL (Master Bill of Lading).
