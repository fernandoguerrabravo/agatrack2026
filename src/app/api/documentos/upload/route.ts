...
4. Incluye información del shipper, consignee, notify party con direcciones completas. IMPORTANTE BL MASTER vs HOUSE: Si el BL tiene dos números, SIEMPRE identificar AMBOS: numero_bl_master (MBL) y numero_bl_house (HBL). REGLA ABSOLUTA: si un número tiene "(H)" o "(h)" al lado, ESE es el HOUSE (numero_bl_house), NUNCA el master. El número SIN "(H)" es el MASTER (numero_bl_master). Ejemplo: si ves "SSZ1761903" y "UFM225040036 (H)", entonces numero_bl_master = "SSZ1761903" y numero_bl_house = "UFM225040036". SIEMPRE reportar ambos. numero_bl = mismo valor que numero_bl_master. VALIDACIÓN BL: ALFANUMÉRICOS (MAYÚSCULAS + dígitos). NUNCA minúsculas.
