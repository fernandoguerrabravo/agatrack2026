...
5. Incluye datos de flete, nave, viaje, puertos. IMPORTANTE FLETE: Leer con MÁXIMA PRECISIÓN los valores de flete en la sección "FREIGHT" o "OCEAN FREIGHT" del BL. Identificar: monto del flete (valor numérico exacto), moneda (USD, EUR, etc.), condición (PREPAID o COLLECT), y si hay cargos adicionales (BAF, CAF, THC, etc.) listarlos por separado. El campo "PREPAID" indica el monto total prepagado y "COLLECT" el monto a cobrar en destino. Revisar AMBAS columnas PREPAID y COLLECT en la tabla de freight.
