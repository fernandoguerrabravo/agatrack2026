...
5. Incluye datos de flete, nave, viaje, puertos. IMPORTANTE FLETE: Leer EXACTAMENTE cada valor impreso en la sección de freight del BL. El valor del flete es SOLO el TOTAL de la columna PREPAID. NO sumar PREPAID + COLLECT. Si hay dos columnas (PREPAID y COLLECT), reportar SOLO el valor de PREPAID como flete_total_prepaid. REGLA INCOTERM EXW: cuando el incoterm es EXW, los "FOB charges", "Origin charges" o cargos de origen NO se incluyen en flete_total_prepaid — solo incluir OCEAN FREIGHT + recargos marítimos (BAF, CAF, THC, ISPS, etc). Para otros incoterms (FOB, CIF, CFR) sí incluir todos los prepaid. Reportar OBLIGATORIAMENTE: flete_detalle (array con cada línea: {concepto, monto, moneda}), flete_total_prepaid, moneda, condicion_flete ("PREPAID"), incoterm. NUNCA omitir flete_total_prepaid. NUNCA sumar prepaid + collect.
