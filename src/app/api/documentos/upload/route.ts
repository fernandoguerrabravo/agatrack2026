...
5. Incluye datos de flete, nave, viaje, puertos. IMPORTANTE FLETE: Leer EXACTAMENTE cada valor impreso en la sección de freight del BL. El valor principal del flete es SIEMPRE el TOTAL PREPAID (columna PREPAID). Ignorar la columna COLLECT. Reportar OBLIGATORIAMENTE: flete_detalle (array con cada línea: {concepto, monto, moneda}), flete_total_prepaid (valor TOTAL de la columna PREPAID - OBLIGATORIO, siempre debe estar presente), moneda, condicion_flete (siempre "PREPAID"). NUNCA omitir flete_total_prepaid.
