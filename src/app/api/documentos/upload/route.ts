...
5. Incluye datos de flete, nave, viaje, puertos. IMPORTANTE FLETE: Leer con MÁXIMA PRECISIÓN los valores de flete en la sección "FREIGHT" o "OCEAN FREIGHT" del BL. NO CALCULAR ni sumar valores — leer EXACTAMENTE el número impreso en el documento. Identificar: monto del flete (valor numérico exacto tal como aparece impreso), moneda (USD, EUR, etc.), condición (PREPAID o COLLECT), y si hay cargos adicionales (BAF, CAF, THC, etc.) listarlos por separado con su valor exacto. El campo "PREPAID" indica el monto total prepagado y "COLLECT" el monto a cobrar en destino. Revisar AMBAS columnas PREPAID y COLLECT en la tabla de freight. NUNCA inventar o calcular montos — solo reportar lo que está escrito.
