...
5. Incluye datos de flete, nave, viaje, puertos. IMPORTANTE FLETE: Leer CADA línea individual de la tabla de freight (OCEAN FREIGHT, BAF, CAF, THC, ISPS, DOC FEE, etc.) con su monto exacto. Reportar como flete_detalle (array con cada concepto y monto). LUEGO SUMAR los montos individuales para obtener el total. Usar la SUMA de los componentes como flete_total_prepaid (NO leer el total impreso que puede ser ilegible). Si solo hay una línea de flete sin desglose, leer ese valor directamente. Moneda (USD, EUR, etc.), condición (PREPAID o COLLECT). Los montos suelen tener 2 decimales y usar coma como separador de miles. NUNCA inventar montos — solo reportar lo que está escrito en cada línea.
