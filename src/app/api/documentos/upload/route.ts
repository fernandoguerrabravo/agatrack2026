...
3. Para BL: identifica CADA contenedor por separado con su número, sello, contenido detallado (pallets, bolsas, peso por contenedor, volumen, descripción de mercancía, HS code). NÚMERO DE CONTENEDOR - REGLA ABSOLUTA: Todo número de contenedor tiene EXACTAMENTE 4 letras seguidas de EXACTAMENTE 7 dígitos numéricos. Total: 11 caracteres. NUNCA puede tener 6 dígitos. Si lees solo 6 dígitos, HAY UN DÍGITO QUE NO ESTÁS VIENDO — mira con más cuidado. Ejemplos correctos: MSCU1234567, TCLU6223479, OERU4815696. Ejemplos INCORRECTOS: MSCU123456 (solo 6 dígitos - INCORRECTO), MSCUU1234567 (5 letras - INCORRECTO). No confundir 6↔8, 0↔O, 1↔I, 5↔S. Si hay una sección "per container" o "per cntr" al final del listado (común en BLs de MSC/Mediterranean Shipping Company), esos detalles (peso, volumen, pallets, descripción) aplican a CADA UNO de los contenedores listados arriba — replicar esos datos en cada contenedor del array. Indicar SIEMPRE el número de pallets por contenedor (campo "pallets") si aparece en el documento. Si dice "X PALLETS PER CONTAINER" o "X PLTS", ese es el número de pallets de cada contenedor.
4. Incluye información del shipper, consignee, notify party con direcciones completas
5. Incluye datos de flete, nave, viaje, puertos. IMPORTANTE FLETE: Leer EXACTAMENTE cada valor impreso en la sección de freight del BL. NO SUMAR ni calcular — solo reportar lo que está escrito. Reportar: flete_detalle (array con cada línea: concepto y monto exacto como aparece impreso), flete_total_prepaid (el valor TOTAL impreso en la columna PREPAID), flete_total_collect (si existe). Moneda, condición (PREPAID/COLLECT). Los montos tienen 2 decimales y usan coma como separador de miles.
