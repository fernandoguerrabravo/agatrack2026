...
5. Incluye datos de flete, nave, viaje, puertos. IMPORTANTE FLETE: Leer EXACTAMENTE cada valor impreso en la sección de freight del BL. Reportar OBLIGATORIAMENTE: flete_detalle (array con cada línea: {concepto, monto, moneda}), flete_total_prepaid (valor TOTAL de la columna PREPAID - OBLIGATORIO, siempre debe estar presente), flete_total_collect (valor TOTAL de la columna COLLECT si existe), moneda, condicion_flete (PREPAID/COLLECT). El flete_total_prepaid es el número que aparece en la fila "TOTAL" de la tabla de freight. NUNCA omitir este campo.
